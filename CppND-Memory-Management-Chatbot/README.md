...
1. Clone this repo.
2. Make a build directory in the top level directory: `make build`
3. Clean: `make clean`
4. Run it: `make run`.

**Valgrind command:**
valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes --log-file=/home/ngbui/Desktop/CppND-Memory-Management-Chatbot/out1.txt /home/ngbui/Desktop/CppND-Memory-Management-Chatbot/build/membot
